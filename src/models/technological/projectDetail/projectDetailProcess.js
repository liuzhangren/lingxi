...
import {
  ...
  newProcessEditDatasRecordsConstant,
...
export default modelExtend(projectDetail, {
  ...
  state: {
    datas: {
      ...
      formDatas: JSON.parse(JSON.stringify(newProcessEditDatasRecordsConstant)),

      newProcessContentCollectionTextBox: JSON.parse(JSON.stringify(newProcessContentCollectionTextBox)),
      newProcessContentCollectionDateBox: JSON.parse(JSON.stringify(newProcessContentCollectionDateBox)),
      newProcessContentCollectionSelectBox: JSON.parse(JSON.stringify(newProcessContentCollectionSelectBox)),
      newProcesssContentCollectionUpload: JSON.parse(JSON.stringify(newProcesssContentCollectionUpload)),
      newProcessContentCollection: JSON.parse(JSON.stringify(newProcessContentCollection)),
      newProcessApprove: JSON.parse(JSON.stringify(newProcessApprove)),
      newProcessCopySend: JSON.parse(JSON.stringify(newProcessCopySend)),
  ...
  effects: {
    ...
    * saveProcessTemplate({ payload }, { select, call, put }) {
      const { formDatas } = payload
      
      let res = yield call(saveProcessTemplate, formDatas)
      debugger
      if(isApiResponseOk(res)) {
        yield put({
          type: 'getProcessTemplateList',
